// CoinFallScript - Phiên bản cơ bản
...
public class CoinFallScript : MonoBehaviour
{
    ...
    private float spawnInterval = 3f; //tần suất spawn: 3 giây / 1 Coin
    ...
    void Update()
    {
        ...
        {
            SpawnCoin(); // Gọi hàm sinh viên ngọc.
    ...
    void SpawnCoin()
    {
      	...
      	/* Khai báo và tạo một biến có giá trị ngẫu nhiên trong khoảng màn hình trước khi tạo Coin mới. 
        ...
        */
		...
		//Khai báo một biến tọa độ vị trí và lưu giá trị tọa độ trên
      	...
      	//Đưa tọa độ này vào function (hàm) Instantiate để tạo và thả viên Coin mới
